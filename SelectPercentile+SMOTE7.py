...
for i in list(s):
    ...
    f.write('percentile LogisticRegression: {}'.format(i))
    f.write("\n")
    ...
    plt.savefig(str(i)+"SMOTEROCLR.tif", format = "tiff", dpi = 300, bbox_inches = 'tight')
    plt.show()
...
for i in list(s):
    ...
    f.write('percentile SVM: {}'.format(i))
    f.write("\n")
    ...
    plt.xlabel('false positive rate(FPR)')
    plt.ylabel('true positive rate(TPR)')
    plt.savefig(str(i)+"SMOTEROCSVM.tif", format = "tiff", dpi = 300, bbox_inches = 'tight')
    plt.show()
    print('confusion matrix = \n', confusion_matrix(y_true = y_test, y_pred = y_prob_pred))
...
for i in list(s):
    ...
    f.write('percentile RF: {}'.format(i))
    f.write("\n")
    ...
    plt.xlabel('false positive rate(FPR)')
    plt.ylabel('true positive rate(TPR)')
    plt.savefig(str(i)+"SMOTEROCRF.tif", format = "tiff", dpi = 300, bbox_inches = 'tight')
    plt.show()
    print('confusion matrix = \n', confusion_matrix(y_true = y_test, y_pred = y_prob_pred))
    plt.clf()
    ...
    plt.savefig(str(i)+"SMOTEfeatureimportanceRF.tif", format= "tiff", dpi = 300, bbox_inches = 'tight')
    plt.clf()
...
for i in list(s):
    ...
    f.write('percentile LGBM: {}'.format(i))
    f.write("\n")
    ...
    plt.xlabel('false positive rate(FPR)')
    plt.ylabel('true positive rate(TPR)')
    plt.savefig(str(i)+"SMOTEROCLGBM.tif", format = "tiff", dpi = 300, bbox_inches = 'tight')
    plt.show()
    plt.clf()
    print('confusion matrix = \n', confusion_matrix(y_true = y_test, y_pred = y_prob_pred))
    ...
    fi_df
    sns.barplot(fi_df['feature importance'],fi_df['feature'])
    plt.savefig(str(i)+"SMOTEfeatureimportanceLGBM.tif", format= "tiff", dpi = 300, bbox_inches = 'tight')
    plt.clf()
