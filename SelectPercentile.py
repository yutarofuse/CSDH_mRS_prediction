...
for i in list(s):
    ...
    plt.savefig(str(i)+"ROCLR.tif", format = "tiff", dpi = 300, bbox_inches = 'tight')
    plt.show()
...
for i in list(s):
    ...
    plt.xlabel('false positive rate(FPR)')
    plt.ylabel('true positive rate(TPR)')
    plt.savefig(str(i)+"ROCSVM.tif", format = "tiff", dpi = 300, bbox_inches = 'tight')
    plt.show()
    print('confusion matrix = \n', confusion_matrix(y_true = y_test, y_pred = y_prob_pred))
...
for i in list(s):
    ...
    plt.xlabel('false positive rate(FPR)')
    plt.ylabel('true positive rate(TPR)')
    plt.savefig(str(i)+"ROCRF.tif", format = "tiff", dpi = 300, bbox_inches = 'tight')
    plt.show()
    print('confusion matrix = \n', confusion_matrix(y_true = y_test, y_pred = y_prob_pred))
    plt.clf()
    ...
    plt.savefig(str(i)+"featureimportanceRF.tif", format= "tiff", dpi = 300, bbox_inches = 'tight')
    plt.clf()
...
for i in list(s):
    ...
    plt.xlabel('false positive rate(FPR)')
    plt.ylabel('true positive rate(TPR)')
    plt.savefig(str(i)+"ROCLGBM.tif", format = "tiff", dpi = 300, bbox_inches = 'tight')
    plt.show()
    plt.clf()
    print('confusion matrix = \n', confusion_matrix(y_true = y_test, y_pred = y_prob_pred))
    ...
    fi_df
    sns.barplot(fi_df['feature importance'],fi_df['feature'])
    plt.savefig(str(i)+"featureimportanceLGBM.tif", format= "tiff", dpi = 300, bbox_inches = 'tight')
    plt.clf()
