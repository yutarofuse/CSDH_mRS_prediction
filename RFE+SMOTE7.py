...
plt.savefig("RFESMOTEROCLR.tif", format = "tiff", dpi = 300, bbox_inches = 'tight')
plt.show()
...
plt.xlabel('false positive rate(FPR)')
plt.ylabel('true positive rate(TPR)')
plt.savefig("RFESMOTEROCSVM.tif", format = "tiff", dpi = 300, bbox_inches = 'tight')
plt.show()
print('confusion matrix = \n', confusion_matrix(y_true = y_test, y_pred = y_prob_pred))
...
plt.xlabel('false positive rate(FPR)')
plt.ylabel('true positive rate(TPR)')
plt.savefig("RFESMOTEROCRF.tif", format = "tiff", dpi = 300, bbox_inches = 'tight')
plt.show()
print('confusion matrix = \n', confusion_matrix(y_true = y_test, y_pred = y_prob_pred))
plt.clf()
...
plt.savefig("RFESMOTEfeatureimportanceRF.tif", format= "tiff", dpi = 300, bbox_inches = 'tight')
plt.clf()
...
plt.xlabel('false positive rate(FPR)')
plt.ylabel('true positive rate(TPR)')
plt.savefig("RFESMOTEROCLGBM.tif", format = "tiff", dpi = 300, bbox_inches = 'tight')
plt.show()
plt.clf()
print('confusion matrix = \n', confusion_matrix(y_true = y_test, y_pred = y_prob_pred))
...
fi_df
sns.barplot(fi_df['feature importance'],fi_df['feature'])
plt.savefig("RFESMOTEfeatureimportanceLGBM.tif", format= "tiff", dpi = 300, bbox_inches = 'tight')
plt.clf()
